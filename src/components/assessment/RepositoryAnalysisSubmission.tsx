  ...
  return (
    <article className="card form-card">
      ...
      <header className="card-header">
        ...
        <p>Submit a repository analysis generated by the AI analysis prompt.</p>
        <p className="section-description">
          Privacy mode: only scores and category-level data are stored. Free-text findings and
          sensitive details are intentionally not persisted.
        </p>
      </header>
